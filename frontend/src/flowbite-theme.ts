...
const flowbiteTheme: CustomFlowbiteTheme = {
  ...
  sidebar: {
    ...
    item: {
      base: "flex items-center justify-center rounded-lg p-2 text-base font-medium text-gray-900 hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700 my-2",
    },
    collapse: {
      button:
